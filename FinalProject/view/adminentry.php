<html>
 ...
 $code= "";
	if ($_SERVER["REQUEST_METHOD"] == "POST")
   {
     ...
     {
  		 $code=$_POST["code"];
		 header("location: http://localhost/FinalProject/amain.php");
  	 }
...
Enter to your Accout<br>
		<h2><form action="" method="post">
			<table>
				
				<tr>
					<td><input type="text" placeholder="Entry-Pass" name="code" value="<?php echo $code?>"<span><?php echo $codeErr
					?></span></td>
				</tr>
